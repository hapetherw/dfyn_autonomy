...
function parseCurrencyFromURLParameter(urlParam: any): string {
  if (typeof urlParam === 'string') {
    ...
    if (urlParam.toUpperCase() === 'ETH') return 'Matic'
  ...
  useEffect(() => {
    ...
    dispatch(
      replaceSwapState({
        ...
        inputCurrencyId: parsed[Field.INPUT].currencyId === "Matic" ? "ETH" : parsed[Field.INPUT].currencyId,
        outputCurrencyId: parsed[Field.OUTPUT].currencyId,
        recipient: parsed.recipient
      })
    )

    setResult({ inputCurrencyId: parsed[Field.INPUT].currencyId === "Matic" ? "ETH" : parsed[Field.INPUT].currencyId, outputCurrencyId: parsed[Field.OUTPUT].currencyId })
